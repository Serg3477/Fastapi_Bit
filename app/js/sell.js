function openSellModal(button) {
  const container = document.getElementById('sellModalContainer');
  ...
  container.innerHTML = `
    <div class="modal-overlay active" data-modal="sell">
      <div class="modal-box">
        <button class="modal-close" onclick="closeModal(this)">×</button>
        <form action="/main/${id}" method="post" class="form-contact">
